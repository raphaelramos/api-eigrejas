...
class CreateWebmasterSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('webmaster_settings', function (Blueprint $table) {
            ...
            $table->integer('social_menu_id');
            $table->integer('app_menu_id');
            $table->integer('app_footer_menu_id');
            $table->integer('app_banners_section_id');
            $table->string('app_sections');
            $table->integer('home_banners_section_id');
            $table->integer('home_text_banners_section_id');
            $table->integer('side_banners_section_id');
            $table->integer('stories_banners_section_id');
            ...
            $table->tinyInteger('member_register_status');
            ...
            $table->integer('home_content_photo_section_id');
            $table->integer('home_content_channel_section_id');
