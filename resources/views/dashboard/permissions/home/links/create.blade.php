        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-lg p-b-0">
                <div class=" p-a">
                        ...
                        @foreach(Helper::languagesList() as $ActiveLanguage)
                            @if($ActiveLanguage->box_status)
                                <div class="form-group row">
                                    <label
                                        class="col-md-3 form-control-label">{!!  __('backend.topicName') !!} {!! @Helper::languageName($ActiveLanguage) !!}
                                    </label>
                                    <div class="col-md-9">
                        ...
                        @endforeach
                        <div class="form-group row">
                            <label class="col-md-3 form-control-label">{!!  __('backend.link') !!}
                            </label>
                            <div class="col-md-9">
                    ...
                    <div class="form-group row">
                        <label for="target0"
                               class="col-md-3 form-control-label">{!!  __('backend.linkTarget') !!}</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 form-control-label"> CSS Class
                        </label>
                        <div class="col-md-9">
