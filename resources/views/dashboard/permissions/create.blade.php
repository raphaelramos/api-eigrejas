        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="form-group row">
                    <label for="name"
                           class="col-md-2 form-control-label">{!!  __('backend.title') !!}
                    </label>
                    <div class="col-md-10">
                ...
                <div class="form-group row">
                    <label for="permissions1"
                           class="col-md-2 form-control-label">{!!  __('backend.dataManagements') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                ...
                <div class="form-group row">
                    <label for="analytics_status"
                           class="col-md-2 form-control-label">{!!  __('backend.activeApps') !!}
                    </label>
                    <div class="col-md-10">
                        <div class="row">
                            <div class="col-md-4">
                ...
                <div class="form-group row">
                    <label for="data_sections0"
                           class="col-md-2 form-control-label">{!!  __('backend.activeSiteSections') !!}
                    </label>
                    <div class="col-md-10">
                        <div class="row">
                            <?php
                ...
                <div class="form-group row">
                    <label for="add_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.topicsStatus') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md" style="margin-bottom: 5px;">
                ...
                <div class="form-group row">
                    <label for="delete_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.deletePermission') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md" style="margin-bottom: 5px;">
