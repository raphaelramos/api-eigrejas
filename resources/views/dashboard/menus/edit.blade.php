        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="form-group row">
                    <label for="father_id"
                           class="col-md-3 form-control-label">{!!  __('backend.fatherSection') !!} </label>
                    <div class="col-md-9">
                ...
                @foreach(Helper::languagesList() as $ActiveLanguage)
                    @if($ActiveLanguage->box_status)
                        <div class="form-group row">
                            <label
                                class="col-md-3 form-control-label">{!!  __('backend.bannerTitle') !!} {!! @Helper::languageName($ActiveLanguage) !!}
                            </label>
                            <div class="col-md-9">
                ...
                <div class="form-group row">
                    <label for="link_status"
                           class="col-md-3 form-control-label">{!!  __('backend.linkType') !!}</label>
                    <div class="col-md-9">
                        <div class="radio">
                ...
                <div id="link_div" class="form-group row" style="{{ ($Menus->type ==1)? "":"display: none" }}">
                    <label for="link"
                           class="col-md-3 form-control-label">{!!  __('backend.linkURL') !!}
                    </label>
                    <div class="col-md-9">
                ...
                <div id="cat_div" class="form-group row" style="{{ ($Menus->type <2)? "display: none":"" }}">
                    <label for="link"
                           class="col-md-3 form-control-label">{!!  __('backend.linkSection') !!}
                    </label>
                    <div class="col-md-9">
