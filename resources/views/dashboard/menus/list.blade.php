...
@section('content')
    <div class="padding">
        ...
        ?>
        <div class="row">
            <div class="col ww-md w-auto-xs light lt bg-auto hidden-print">
                                        ...
                                        @foreach($ParentMenus as $ParentMenu)
                                            ...
                                            <li style="margin-bottom: 5px"
                                                ...
                                                <a href="{{ route("menus",["ParentMenuId"=>$ParentMenu->id]) }}"
                                                    {!!   ($ParentMenu->id == $edt_id) ? " style='font-weight: bold;color:#0a5687'":""  !!} >
                                                    {!! $title !!}
                                                </a>
                        ...
                        <div class="box">
                            ...
                            @if($Menus->total() > 0)
                                    ...
                                    <table class="table table-bordered m-a-0">
                                        ...
                                        @foreach($Menus as $Menu)
                                            ...
                                            <tr>
                                                ...
                                                <td  class="h6">
                                                    {!! Form::text('row_no_'.$Menu->id,$Menu->row_no, array('class' => 'form-control row_no')) !!}
                                                    {!! $title  !!}</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img
                                                            ...
                                                            class="submenu_tree">
                                                        {!! Form::text('row_no_'.$subMenu->id,$subMenu->row_no, array('class' => 'form-control row_no')) !!}
                                                        {!! $title  !!}</td>
                                                    <td class="text-center">
                                ...
                                <footer class="dker p-a">
                                    <div class="row">
                                        <div class="col-md-4 hidden-xsd-none d-sm-block">
