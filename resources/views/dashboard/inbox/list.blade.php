...
@section('content')
        ...
        <div id="mg-{{ $WebmailsGroup->id }}" class="modal fade"
            ...
            <div class="modal-dialog" id="animate">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-xs-center p-lg">
                        <p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-2 ww-md w-auto-xs light lt bg-auto  hidden-print">
                <div class="padding pos-rlt">
                    <div class="btn-group">
                        <a href="{{ route('webmails',['group_id'=>'create']) }}"
                        class="btn white btn-lg"> <i class="material-icons">
                                &#xe145;</i>&nbsp; {!! __('backend.compose') !!}</a>
                    </div>
                    <div class="hidden-xsd-none d-sm-block-down m-t" id="inbox-menu">
                        <?php
                        $cat_id = "3";
                                            ...
                                            @foreach($WebmailsGroups as $WebmailsGroup)
                                                <li style="margin-bottom: 5px"
                                                    ...
                                                    <a href="{{ route("webmails",["group_id"=>$WebmailsGroup->id]) }}"
                                                        {!!   ($WebmailsGroup->id == $group_id) ? " style='font-weight: bold;color:#0a5687'":""  !!} >
                    ...
                    <button class="btn btn-secondary b-a no-shadow" type="submit">{!! __('backend.save') !!}</button>
                </span>
                                </div>
                                {{Form::close()}}
                            @else
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <span class="input-group-prepend">
                    <button class="btn btn-secondary b-a no-shadow" type="submit">{!! __('backend.add') !!}</button>
                </span>
                                </div>
                                {{Form::close()}}
                            @endif
                        ...
                        @if( $connectEmailAddress !="" )
                            ...
                            href="<?php echo 'http' . ($useHTTPS ? 's' : '') . '://' . $connectDomainURL . ':' . ($useHTTPS ? '2096' : '2095') . '/login/?user=' . $connectEmailAddress . '&pass=' . $connectEmailPassword . '&failurl=http://' . $connectDomainURL; ?>">
                                ...
                                @if($nMsgCount >0 )
                                    <span class="tag warn m-l-xs">{{ $nMsgCount }}</span>
                                @endif
                            </a>
                        @endif
                    </div>
                                ...
                                <div class="p-a light dk">
                                    <div class="btn-group float-right">
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <span class="input-group-prepend">
                    <button class="btn btn-secondary b-a no-shadow" type="submit"><i class="fa fa-search"></i></button>
                </span>
                                        </div>
                                        {{Form::close()}}
                                    </div>
                                    <div class="btn-toolbar">
                                        ...
                                        <div class="btn-group dropdown">
                                            ...
                                            <div class="dropdown-menu text-xs-left text-sm">
                                    ...
                                    @foreach($Webmails as $Webmail)
                                        ...
                                        <div class="list-item b-l b-l-2x" style="border-color: {{$groupColor}}">
                                            ...
                                            <div class="list-body" style="cursor: pointer;"
                                                ...
                                                <div class="float-right text-muted text-xs">
                                                    <span
                                                        class="hidden-xsd-none d-sm-block  {{$fontStyle}}" {!! $unreadText !!}>{{ $dtformated }}</span>
                                                ...
                                                <div>
                                                    ...
                                                    @if($groupName !="")
                                                        <span class="tag m-l-sm text-u-c" {!! $unreadbg !!}>
                                        {{ $groupName }}
                                        </span>
                                                    @endif
                                                </div>
