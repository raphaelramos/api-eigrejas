    ...
    <div>
        <div class="box">
            ...
            <div class="box-body">
                ...
                $siteTitle_var2 = "site_title_" . \Config::get('app.locale');
                ...
                <div class="form-group row">
                    <label for="title_en"
                           class="col-md-2 form-control-label">{!!  __('backend.sendTo') !!}
                    </label>
                    <div class="col-md-9">
                ...
                <div id="cc" style="<?php echo $cc;?>" class="form-group row">
                    <label for="title_en"
                           class="col-md-2 form-control-label">{!!  __('backend.sendCc') !!}
                    </label>
                    <div class="col-md-9">
                ...
                <div id="bcc" style="<?php echo $bcc;?>" class="form-group row">
                    <label for="title_en"
                           class="col-md-2 form-control-label">{!!  __('backend.sendBcc') !!}
                    </label>
                    <div class="col-md-9">
                ...
                <div class="form-group row">
                    <label for="title_en"
                           class="col-md-2 form-control-label">{!!  __('backend.sendTitle') !!}
                    </label>
                    <div class="col-md-10">
                ...
                <div class="form-group row">
                    <label for="attach_files"
                           class="col-md-2 form-control-label">{!!  __('backend.AttachFiles') !!}</label>
                    <div class="col-md-10">
