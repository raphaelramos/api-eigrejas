    ...
    <div class="p-a-md col-lg-12">
            ...
            @foreach(Helper::languagesList() as $ActiveLanguage)
                <div class="col-md-6 m-b-2">
                    ...
                    @if($Setting->{'style_logo_'.@$ActiveLanguage->code}!="")
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-12 box p-a-xs text-center">
                                    <a target="_blank" href="{{ global_asset($Setting->{'style_logo_'.@$ActiveLanguage->code}) }}">
                                       <img
                                            src="{{ global_asset($Setting->{'style_logo_'.@$ActiveLanguage->code}) }}"
                                            class="img-fluid" id="style_logo_{{ @$ActiveLanguage->code }}_prv"
                    ...
                    @else
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-12 box p-a-xs text-center">
                                    <img
                                        src="{{ global_asset('uploads/settings/nologo.png') }}"
                                        class="img-fluid" id="style_logo_{{ @$ActiveLanguage->code }}_prv"
                                        style="width: auto;max-width: 260px;max-height: 60px">
                                    <br>
                ...
                <div class="col-md-6 m-b-2">
                    <label>{!!  __('backend.siteLogoDark') !!}</label> {!! @Helper::languageName($ActiveLanguage) !!}
                    @if($Setting->{'style_logo_dark_'.@$ActiveLanguage->code}!="")
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-12 box p-a-xs text-center" style="background-color: black">
                                    <a target="_blank" href="{{ global_asset($Setting->{'style_logo_dark_'.@$ActiveLanguage->code}) }}">
                                        <img
                                            src="{{ global_asset($Setting->{'style_logo_dark_'.@$ActiveLanguage->code}) }}"
                                            class="img-fluid" id="style_logo_dark_{{ @$ActiveLanguage->code }}_prv"
                                            style="width: auto;max-width: 260px;max-height: 60px">
                                        <br>
                                    </a>
                                </div>
                    ...
                    @else
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-12 box p-a-xs text-center"  style="background-color: black">
                                    <img
                                        src="{{ global_asset('uploads/settings/nologo-dark.png') }}"
                                        class="img-fluid" id="style_logo_dark_{{ @$ActiveLanguage->code }}_prv"
                                        style="width: auto;max-width: 260px;max-height: 60px">
                                    <br>
                                    <small>nologo.png</small>
                    ...
                    @endif
                    {!! Form::file('style_logo_dark_'.@$ActiveLanguage->code, array('class' => 'form-control','id'=>'style_logo_dark_'.@$ActiveLanguage->code,'accept'=>'image/*')) !!}
                    <small>
                        <i class="material-icons">&#xe8fd;</i>( 260x60 px ) -
                        {!!  __('backend.imagesTypes') !!}
                    </small>
                ...
                @if($Setting->style_fav!="")
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12 box p-a-xs text-center">
                                <a target="_blank"
                                   href="{{ global_asset($Setting->style_apple) }}"><img
                                        src="{{ global_asset($Setting->style_apple) }}"
                                        class="img-fluid" id="style_fav_prv"
                ...
                @else
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12 box p-a-xs text-center">
                                <a target="_blank"
                                   href="{{ global_asset('uploads/settings/nofav.png') }}"><img
                                        src="{{ global_asset('uploads/settings/nofav.png') }}"
                                        class="img-fluid" id="style_fav_prv"
                                        style="max-width: 60px;height: 60px">
                                    <br>
        ...
        <div class="form-group row">
            <div class="col-md-4">
                ...
                <div>
                    <div id="cp1" class="input-group colorpicker-component">
                        ...
                        <span class="input-group-prepend" id="cpbg"><i></i></span>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                ...
                <div>
                    <div id="cp2" class="input-group colorpicker-component">
                        ...
                        <span class="input-group-prepend" id="cpbg2"><i></i></span>
                    </div>
                </div>
                <small><a href="javascript:null"
            ...
            <div class="col-md-4">
                ...
                <small><a href="javascript:null"
                          onclick="update_restcolor3()">{!!  __('backend.restoreDefault') !!}</a>
                </small>
            </div>
        </div>
        <hr>
                        ...
                        @for($i=1;$i<=24;$i++)
                            ...
                            <div class="col-md-3">
                                <label class="ui-check ui-check-md">
                                    ...
                                    <i class="dark-white"></i>
                                    <img src="{{ global_asset('uploads/pattern/'.$img_name) }}"
                        ...
                        @if($Setting->style_bg_image!="")
                            <div>
                                <div>
                                    <div class="col-md-12 box p-a-xs text-center">
                                        <a target="_blank"
                                           href="{{ global_asset($Setting->style_bg_image) }}"><img
                                                src="{{ global_asset($Setting->style_bg_image) }}"
                                                class="img-fluid"
            ...
            <div class="row">
                <div class="col-md-6">
                    @if($Setting->style_footer_bg!="")
                        <div>
                            <div>
                                <div id="footer_bg" class="col-md-8 box p-a-xs">
                                    <a target="_blank"
                                       href="{{ global_asset($Setting->style_footer_bg) }}"><img
                                            src="{{ global_asset($Setting->style_footer_bg) }}"
                                            class="img-fluid">
        ...
        <hr>
        <div class="form-group">
            <label>{{ __('backend.appSite') }} : </label>
            <div class="radio">
                <label class="ui-check ui-check-md">
                    {!! Form::radio('site_app_banner','1',$Setting->site_app_banner ? true : false , array('id' => 'site_app_banner1','class'=>'has-value')) !!}
                    <i class="dark-white"></i>
                    {{ __('backend.active') }}
                </label>
                &nbsp; &nbsp;
                <label class="ui-check ui-check-md">
                    {!! Form::radio('site_app_banner','0',$Setting->site_app_banner ? false : true , array('id' => 'site_app_banner2','class'=>'has-value')) !!}
                    <i class="dark-white"></i>
                    {{ __('backend.notActive') }}
                </label>
            </div>
