...
@push("after-styles")
    <link rel="stylesheet"
          href="{{ global_asset('assets/dashboard/js/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css') }}"
          type="text/css"/>
@endpush
@section('content')
    <div class="padding">
        <div class="row-col">
            ...
            <div class="col-md-7 col-lg-10 light lt">
                ...
                <div class="tab-content pos-rlt">
                    <button type="submit" class="btn primary m-a float-right"><i class="material-icons">&#xe31b;</i> {{ __('backend.update') }}</button>
...
@push("after-scripts")
    ...
    <script src="{{ global_asset('assets/dashboard/js/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js') }}"></script>
    <script>
        $(function () {
            $('#cp1').colorpicker({
                colorSelectors: {
        ...
        function update_restcolor3() {
            document.getElementById("style_color3").value = '#3494c8';
            $("#cpbg3 i").css("background-color", "#3494c8");
        }
    </script>
    <script type="text/javascript">
        ...
        $("#style_logo_dark_{{ @$ActiveLanguage->code }}").change(function () {
            readURL(this, "style_logo_dark_{{ @$ActiveLanguage->code }}_prv");
        });
        @endforeach
