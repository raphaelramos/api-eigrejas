        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="form-group row">
                    <label for="name"
                           class="col-md-2 form-control-label">{!!  __('backend.fullName') !!}
                    </label>
                    <div class="col-md-10">
                ...
                <div class="form-group row">
                    <label for="email"
                           class="col-md-2 form-control-label">{!!  __('backend.loginEmail') !!}
                    </label>
                    <div class="col-md-10">
                ...
                <div class="form-group row">
                    <label for="password"
                           class="col-md-2 form-control-label">{!!  __('backend.loginPassword') !!}
                    </label>
                    <div class="col-md-10">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        @if($Users->photo!="")
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="user_photo" class="col-md-4 box p-a-xs">
                                        <a target="_blank"
                ...
                @if(@Auth::user()->permissionsGroup->webmaster_status)
                    <div class="form-group row">
                        <label for="permissions1"
                               class="col-md-2 form-control-label">{!!  __('backend.Permission') !!}</label>
                        <div class="col-md-10">
                            <div class="radio">
