...
<div class="tab-pane {{  ( Session::get('active_tab') == 'registrationSettingsTab') ? 'active' : '' }}"
    ...
    <div class="p-a-md col-lg-12">
        ...
        <div class="form-group">
            ...
            <div class="float-right text-muted" dir="ltr">
                {{ env("APP_URL") }}/
            </div>
        ...
        <div class="row m-t-3">
            ...
            <div class="col-lg-8" id="facebook_ids_div"
                 style="display: {{ ($WebmasterSetting->login_facebook_status==1)?"block":"none" }}">
                <div class="form-group row">
                    <label
                        class="col-md-2 form-control-label">{!!  __('backend.loginAppID') !!}</label>
                    <div class="col-md-10">
                ...
                <div class="form-group row">
                    <label
                        class="col-md-2 form-control-label">{!!  __('backend.loginAppSecret') !!}</label>
                    <div class="col-md-10">
        ...
        <div class="row m-t-2">
            ...
            <div class="col-lg-8" id="twitter_ids_div"
                 style="display: {{ ($WebmasterSetting->login_twitter_status==1)?"block":"none" }}">
                <div class="form-group row">
                    <label
                        class="col-md-2 form-control-label">{!!  __('backend.loginConsumerAppKey') !!}</label>
                    <div class="col-md-10">
                ...
                <div class="form-group row">
                    <label
                        class="col-md-2 form-control-label">{!!  __('backend.loginConsumerAppSecret') !!}</label>
                    <div class="col-md-10">
        ...
        <div class="row m-t-2">
            ...
            <div class="col-lg-8" id="google_ids_div"
                 style="display: {{ ($WebmasterSetting->login_google_status==1)?"block":"none" }}">
                <div class="form-group row">
                    <label
                        class="col-md-2 form-control-label">{!!  __('backend.loginClientID') !!}</label>
                    <div class="col-md-10">
                ...
                <div class="form-group row">
                    <label
                        class="col-md-2 form-control-label">{!!  __('backend.loginClientSecret') !!}</label>
                    <div class="col-md-10">
        ...
        <div class="row m-t-2">
            ...
            <div class="col-lg-8" id="linkedin_ids_div"
        ...
        <div class="row m-t-2">
            ...
            <div class="col-lg-8" id="github_ids_div"
        ...
        <div class="row m-t-2">
            ...
            <div class="col-lg-8" id="bitbucket_ids_div"
                 style="display: {{ ($WebmasterSetting->login_bitbucket_status==1)?"block":"none" }}">
                <div class="form-group row">
                    <label
                        class="col-md-2 form-control-label">{!!  __('backend.loginKey') !!}</label>
                    <div class="col-md-10">
                ...
                <div class="form-group row">
                    <label
                        class="col-md-2 form-control-label">{!!  __('backend.loginSecret') !!}</label>
                    <div class="col-md-10">
