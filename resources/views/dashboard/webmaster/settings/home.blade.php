...
@push("after-styles")
    <link rel="stylesheet" href="{{ global_asset('assets/dashboard/js/sweetalert/sweetalert.css') }}">
    <link href="{{ global_asset("assets/dashboard/js/iconpicker/fontawesome-iconpicker.min.css") }}" rel="stylesheet">
    <!--[if lt IE 9]>
...
@section('content')
    ...
    <div class="padding">
        <div class="row-col">
                ...
                <div class="p-y">
                    <div class="nav-active-border left b-primary">
                        <ul class="nav nav-sm">
                            ...
                            <li class="nav-item">
                                <a class="nav-link block {{  ( Session::get('active_tab') == 'frontAppSettingsTab') ? 'active' : '' }}"
                                   href
                                   data-toggle="tab" data-target="#tab-12"
                                   onclick="document.getElementById('active_tab').value='frontAppSettingsTab'">
                                    &nbsp; {!!  __('backend.frontAppSettings') !!}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link block {{  ( Session::get('active_tab') == 'nomenclaturesSettingsTab') ? 'active' : '' }}"
                                   href
                                   data-toggle="tab" data-target="#tab-13"
                                   onclick="document.getElementById('active_tab').value='nomenclaturesSettingsTab'">
                                    &nbsp; {!!  __('backend.nomenclaturesSettings') !!}</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="col-md-7 col-lg-10 light lt">
                ...
                <div class="tab-content pos-rlt">
                    ...
                    @include('dashboard.webmaster.settings.front-app')
                    @include('dashboard.webmaster.settings.nomenclatures')
                    ...
                    <button type="submit" id="save-settings-btn" class="btn primary m-a float-right">
...
@endsection
@push("after-scripts")
    <script src="{{ global_asset('assets/dashboard/js/sweetalert/sweetalert.min.js') }}"></script>
    <script type="text/javascript">
        ...
        $('#smtp_check').click(function () {
            if ($("#mail_host").val() != "" && $("#mail_port").val() != "") {
                $('#smtp_check').html("<img src=\"{{ global_asset('assets/dashboard/images/loading.gif') }}\" style=\"height: 20px\"/> {!! __('backend.smtpCheck') !!}");
