        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-lg">
                <div class="form-group row">
                    <label for="name"
                           class="col-md-3 form-control-label">{{ __('backend.languageCode') }}</label>
                    <div class="col-md-9">
                ...
                <div class="form-group row">
                    <label for="name"
                           class="col-md-3 form-control-label">{{ __('backend.languageTitle') }}</label>
                    <div class="col-md-9">
                ...
                <div class="form-group row">
                    <label for="name"
                           class="col-md-3 form-control-label">{{ __('backend.languageDirection') }}</label>
                    <div class="col-md-9">
                ...
                <div class="form-group row">
                    <label for="name"
                           class="col-md-3 form-control-label">{{ __('backend.languageInputFields') }}</label>
                    <div class="col-md-9">
                ...
                <div class="form-group row">
                    <label for="name"
                           class="col-md-3 form-control-label">{{ __('backend.languageIcon') }}</label>
                    <div class="col-md-9">
                        <select name="icon"
