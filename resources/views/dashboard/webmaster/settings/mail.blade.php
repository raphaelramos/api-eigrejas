<div class="tab-pane {{  ( Session::get('active_tab') == 'mailSettingsTab') ? 'active' : '' }}"
    ...
    <div class="p-a-md col-lg-12 b-b m-b-2">
        <div class="row">
            ...
            <div class="col-md-5 form-group {{ (env("MAIL_DRIVER") != "sendmail" && env("MAIL_DRIVER") != "")?"":"displayNone" }}"
                 id="mail_host_div">
                <label>{!!  __('backend.mailHost') !!}</label>
                {!! Form::text('mail_host',env("MAIL_HOST"), array('id' => 'mail_host','class' => 'form-control', 'dir'=>'ltr')) !!}
            </div>
            <div class="col-md-2 form-group {{ (env("MAIL_DRIVER") != "sendmail" && env("MAIL_DRIVER") != "")?"":"displayNone" }}"
                 id="mail_port_div">
            ...
            <div class="col-md-7 form-group {{ (env("MAIL_DRIVER") != "sendmail" && env("MAIL_DRIVER") != "")?"":"displayNone" }}"
            ...
            <div class="col-md-7 form-group {{ (env("MAIL_DRIVER") == "")?"displayNone":"" }}" id="mail_from_div">
        ...
        <button id="smtp_check" type="button"
                class="btn float-right btn-sm info {{ (env("MAIL_DRIVER") == "smtp")?"":"displayNone" }}">
