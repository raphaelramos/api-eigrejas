@if (Session::get('fieldST') == "edit")
    <div>
        ...
        <div class="form-group row">
            <label for="type0"
                   class="col-md-2 form-control-label">{!!  __('backend.customFieldsType') !!}</label>
            <div class="col-md-3">
                <div class="radio">
        ...
        <div class="form-group row">
            <label for="required1"
                   class="col-md-2 form-control-label">{!!  __('backend.customFieldsRequired') !!}</label>
            <div class="col-md-10">
                <div class="radio">
                    <label class="ui-check ui-check-md">
        ...
        <div class="form-group row">
            <label for="in_table1"
                   class="col-md-2 form-control-label">{!!  __('backend.showFieldInTable') !!}</label>
            <div class="col-md-10">
                <div class="radio">
                    <label class="ui-check ui-check-md">
        ...
        <div class="form-group row">
            <label for="in_search1"
                   class="col-md-2 form-control-label">{!!  __('backend.showFieldInSearch') !!}</label>
            <div class="col-md-10">
                <div class="radio">
                    <label class="ui-check ui-check-md">
        ...
        @if($WebmasterSections->type != 4)
            <div class="form-group row">
                <label for="in_listing1"
                       class="col-md-2 form-control-label">{!!  __('backend.showFieldInListing') !!}</label>
                <div class="col-md-10">
                    <div class="radio">
                        <label class="ui-check ui-check-md">
        ...
        <div class="form-group row">
            <label for="in_page1"
                   class="col-md-2 form-control-label">{!!  __('backend.showFieldInPage') !!}</label>
            <div class="col-md-10">
                <div class="radio">
                    <label class="ui-check ui-check-md">
        ...
        <div
            ...
            <label for="in_statics1"
                   class="col-md-2 form-control-label">{!!  __('backend.showStatics') !!}</label>
            <div class="col-md-10">
                <div class="radio">
                    <label class="ui-check ui-check-md">
        ...
        <div class="form-group row" id="default_val"
            ...
            <label for="default_value"
                   class="col-md-2 form-control-label">{!!  __('backend.customFieldsDefault') !!}
            </label>
            <div class="col-md-10">
        ...
        <div class="form-group row">
            <label for="lang_code"
                   class="col-md-2 form-control-label">{!!  __('backend.language') !!}
            </label>
            <div class="col-md-10">
        ...
        <div class="form-group row">
            <label for="css_class"
                   class="col-md-2 form-control-label"> CSS Class </label>
            <div class="col-md-10">
        ...
        <div class="form-group row">
            <label for="css_class"
                   class="col-md-2 form-control-label"> {!!  __('backend.viewPermission') !!}</label>
            <div class="col-md-10">
                <?php
        ...
        <div class="form-group row">
            <label for="css_class"
                   class="col-md-2 form-control-label"> {!!  __('backend.addPermission') !!}</label>
            <div class="col-md-10">
                <?php
        ...
        <div class="form-group row">
            <label for="css_class"
                   class="col-md-2 form-control-label"> {!!  __('backend.editPermission') !!}</label>
            <div class="col-md-10">
                <?php
