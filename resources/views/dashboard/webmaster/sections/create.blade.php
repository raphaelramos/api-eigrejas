            ...
            <div class="box-body">
                ...
                @foreach(Helper::languagesList() as $ActiveLanguage)
                    <div class="form-group row">
                        <label
                            class="col-md-2 form-control-label">{!!  __('backend.sectionName') !!} {!! @Helper::languageName($ActiveLanguage) !!}
                        </label>
                        <div class="col-md-10">
                ...
                <div class="form-group row">
                    <label for="type"
                           class="col-md-2 form-control-label">{!!  __('backend.sectionType') !!}</label>
                    <div class="col-md-10">
                        <div class="radio secs">
                            <div>
                                <label class="ui-check ui-check-md p-y-sm w-100 p-x-2 b-a">
                                    ...
                                    <span class="fa fa-file-text-o sec-icon float-right"></span>
                            ...
                            <div>
                                <label class="ui-check ui-check-md p-y-sm w-100 p-x-2 b-a">
                                    ...
                                    <i class="dark-white"></i>
                                    <span class="material-icons sec-icon float-right">&#xe41d;</span>
                            ...
                            <div>
                                <label class="ui-check ui-check-md p-y-sm w-100 p-x-2 b-a">
                                    ...
                                    <i class="dark-white"></i>
                                    <span class="material-icons sec-icon float-right">&#xe63a;</span>
                                    <strong>{{ __('backend.typeVideosChannel') }}</strong>
                                    <div class="m-x-sm text-muted">{{ __('backend.videoDescChannel') }}</div>
                                </label>
                            </div>
                            <div>
                                <label class="ui-check ui-check-md p-y-sm w-100 p-x-2 b-a">
                            ...
                            <div>
                                <label class="ui-check ui-check-md p-y-sm w-100 p-x-2 b-a">
                                    ...
                                    <i class="dark-white"></i>
                                    <span class="fa fa-table sec-icon float-right"></span>
                ...
                <div class="form-group row">
                    <label for="title_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.titleField') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="date_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.dateField') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="expire_date_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.expireDateField') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="longtext_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.longTextField') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="editor_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.allowEditor') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="case_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.caseField') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="visits_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.visitsField') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="photo_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.photoField') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="attach_file_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.attachFileField') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="section_icon_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.sectionIconPicker') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="icon_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.topicsIconPicker') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="multi_images_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.additionalImages') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="extra_attach_file_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.additionalFiles') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="maps_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.attachGoogleMaps') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="order_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.attachOrderForm') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="comments_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.reviewsAvailable') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="related_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.relatedTopics') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
