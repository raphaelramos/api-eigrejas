    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body">
                    ...
                    <div class="col-md-10">
                        <div class="radio">
                            ...
                            <label class="ui-check ui-check-md">
                                ...
                                <i class="dark-white"></i>
                                {{ __('backend.sectionTypePhoto') }} Stories
                            </label>
                            &nbsp; &nbsp;
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="width"
                           class="col-md-2 form-control-label">{!!  __('backend.size') !!}</label>
                    <div class="col-md-2">
                        {!! Form::number('width','', array('placeholder' => __('backend.width'),'class' => 'form-control','id'=>'width','required'=>'','min'=>'0')) !!}
                    </div>
                    <div class="col-md-1 text-center" style="width: 30px !important;padding-top: 10px;">
                        X
                    </div>
                    <div class="col-md-2">
                ...
                <div class="form-group row">
                    <label for="desc_status"
                           class="col-md-2 form-control-label">{!!  __('backend.descriptionBox') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="link_status"
                           class="col-md-2 form-control-label">{!!  __('backend.linkBox') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                ...
                <div class="form-group row">
                    <label for="icon_status1"
                           class="col-md-2 form-control-label">{!!  __('backend.iconPicker') !!}</label>
                    <div class="col-md-10">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
