...
@push("after-styles")
    <link href="{{ global_asset("assets/dashboard/js/bootstrap-daterangepicker/daterangepicker-bs3.css") }}" rel="stylesheet"
          type="text/css"/>
@endpush
@section('content')
    <div class="padding">
...
@push("after-scripts")
    ...
    <script src="{{ global_asset("assets/dashboard/js/bootstrap-daterangepicker/daterangepicker.js") }}"
