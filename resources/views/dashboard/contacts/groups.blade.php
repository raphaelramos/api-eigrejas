<!-- column -->
<div class="col-md-2 col-lg-2 w w-auto-sm b-r">
    <div class="row-col">
        <div class="row-row">
            <div class=" hover">
                            ...
                            <div class="col-md-9 p-a-0">
                                ...
                                <ul class="list">
                                    ...
                                    <li class="marginBottom5"><a
                                            href="{{ route('contacts') }}" {!!   ($group_id=="") ? " style='font-weight: bold;color:#0a5687'":""  !!}> {{ __('backend.allContacts') }}
                                    ...
                                    @foreach($ContactsGroups as $ContactsGroup)
                                        <li class="marginBottom5"
                                            ...
                                            <a href="{{ route("contacts",["group_id"=>$ContactsGroup->id]) }}" {!!   ($ContactsGroup->id == $group_id) ? " style='font-weight: bold;color:#0a5687'":""  !!} > {!! $ContactsGroup->name !!}
                                    ...
                                    <li class="marginBottom5"><a
                                            {!!   ($group_id=="wait") ? " style='font-weight: bold;color:#0a5687'":""  !!}
                                    ...
                                    <li>
                                        <a {!!   ($group_id=="blocked") ? " style='font-weight: bold;color:#0a5687'":""  !!} href="{{ route("contacts",["group_id"=>"blocked"]) }}"> {{ __('backend.blockedContacts') }}
