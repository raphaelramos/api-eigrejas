                ...
                <div class="row-inner">
                    <div class="padding p-y-sm">
                        ...
                        <div class="row-col h-auto m-b-1">
                            ...
                            <div class="col-md-9 v-m h2 _300">
                                <div class="p-l-xs">
                        ...
                        <div class="form-horizontal">
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label">{{ __('backend.contactPhone') }}</label>
                                <div class="col-md-6">
                                ...
                                @if(Session::get('ContactToEdit')->phone !="")
                                    <div class="col-md-3">
                                        <a href="tel:{{Session::get('ContactToEdit')->phone}}"
                                           class="btn white float-right" style="width: 100%">
                                            <small>
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label">{{ __('backend.contactEmail') }}</label>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route("webmails",["group_id"=>"create","stat"=>"email","wid"=>'new',"contact_email"=>Session::get('ContactToEdit')->email]) }}"
                                       style="width: 100%" class="btn white float-right">
                                        <small>
                                            <i class="material-icons">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label">{{ __('backend.companyName') }}</label>
                                <div class="col-md-9">
                                    {!! Form::text('company',Session::get('ContactToEdit')->company, array('placeholder' =>'','class' => 'form-control','id'=>'company')) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label">{!!  __('backend.country') !!}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label">{{ __('backend.notes') }}</label>
                                <div class="col-md-9">
                                    {!! Form::textarea('notes',Session::get('ContactToEdit')->notes, array('placeholder' => '','class' => 'form-control','rows'=>'2')) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label">{{ __('backend.status') }}</label>
                                <div class="col-md-9">
                                    <div class="radio">
                            ...
                            <div class="form-group row">
                                <div class="col-md-offset-3 col-md-9">
                                    @if(@Auth::user()->permissionsGroup->delete_status)
                                        <button class="btn warning float-right" data-toggle="modal"
