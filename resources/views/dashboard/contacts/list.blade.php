...
@section('content')
    <div class="padding">
        <div class="app-body-inner">
            <div class="row-col row-col">
            @include('dashboard.contacts.groups')
            <!-- column -->
                <div class="col-md-4 col-lg-3 bg b-r">
                    <div class="row-col">
                        <div class="p-a-xs b-b">
                            ...
                            <div class="input-group">
                                ...
                                <button type="submit" style="padding-top: 10px;"
                                        class="input-group-prepend no-border no-shadow no-bg float-left"><i
                    ...
                    <span class="w-40 avatar">
                        <a href="{{ route("contactsEdit",["id"=>$Contact->id]) }}">
                            @if($Contact->photo!="")
                                <img src="{{ asset('uploads/contacts/'.$Contact->photo) }}" class="rounded-circle">
                            @else
                                <img src="{{ asset('uploads/contacts/profile.jpg') }}" class="rounded-circle"
                                     style="opacity: 0.5">
                            @endif
                        </a>
                    </span>
                        ...
                        @if($Contacts->total() > \Config::get('front.backend_pagination'))
