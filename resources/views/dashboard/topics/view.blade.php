                                                ...
                                                <div class="row field-row {!! $customField->css_class !!}">
                                                    ...
                                                    <div class="col-md-10">
                                                        <video width="100%" height="450" controls>
                                                            <source src="{{ URL::to($cf_saved_val) }}"
                                                                    type="video/mp4">
                        ...
                        <div class="bottom-article">
                            ...
                            @else
                                <a href="{{ URL::to($Topic->attach_file) }}">
                                    <strong>
                                        {!! Helper::GetIcon(URL::to(),$Topic->attach_file) !!}
                                ...
                                <div class="col-md-3 text-center">
                                    <a href="{{ URL::to($attachFile->file) }}" target="_blank"
                                       style="padding: 10px;border: 1px dashed #ccc;margin-bottom: 10px;display: block;background: #f9f9f9">
                                        <strong>
                                            {!! Helper::GetIcon(URL::to(),$attachFile->file,40) !!}
                                            <br>
                                            &nbsp;{{ $file_title }}</strong>
                                    </a>
                                </div>
                        ...
                        @if(count($Topic->approvedComments)>0)
                            <div class="streamline b-l m-b m-l">
                                ...
                                @foreach($Topic->approvedComments as $comment)
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left">
                                            <img src="{{ URL::to('uploads/contacts/profile.jpg') }}" class="rounded-circle">
                                        </div>
