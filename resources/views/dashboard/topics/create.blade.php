        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                @if($WebmasterSection->date_status)
                    <div class="form-group row">
                        <label for="date"
                               class="col-md-2 form-control-label">{!!  __('backend.topicDate') !!}
                        </label>
                        <div class="col-md-10">
                            <div class="form-group">
                                <div class="input-group date">
                                    {!! Form::input('dateTime-local', 'date', Helper::formatDateTime(), ['id' => 'date', 'class' => 'form-control']) !!}
                                </div>
                            </div>
            ...
            onImageUpload: function(files, editor, welEditable) {
                ...
                @if($WebmasterSection->type==2)
                    ...
                    <div id="files_div" style="display: none">
                        <div class="form-group row">
                    ...
                    <div class="form-group row" id="youtube_link_div" style="display: block">
                        ...
                        <div class="col-md-10">
                            {!! Form::text('youtube_link','', array('placeholder' => 'https://www.youtube.com/watch?v=4JyMr2O6zQ0','class' => 'form-control','id'=>'youtube_link', 'dir'=>'ltr')) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row" id="embed_link_div" style="display: none">
                        <label for="embed_link"
                               class="col-md-2 form-control-label">Embed Code</label>
                        <div class="col-md-10">
                ...
                @if($WebmasterSection->type==6)
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {!! Form::text('youtube_channel','', array('placeholder' => 'https://www.youtube.com/channel/UCm5y5YVK9eJw7Pv6CT1bizQ','class' => 'form-control','id'=>'youtube_channel','required'=>'true','dir'=>'ltr')) !!}
                        </div>
                    </div>
                @endif
