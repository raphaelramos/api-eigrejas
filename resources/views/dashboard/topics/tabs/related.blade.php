                    ...
                    <div>
                        ...
                        <div class="form-group row">
                            <label for="file_title_ar"
                                   class="col-md-2 form-control-label">{!!  __('backend.siteSectionsSettings') !!}
                            </label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group row">
                            <label for="file_title_ar"
                                   class="col-md-2 form-control-label">{!!  __('backend.relatedTopics') !!}
                            </label>
                            <div class="col-md-10">
                                <div id="r_topics"
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($Topics->relatedTopics as $relatedTopic)
                            ...
                            <tr>
                                ...
                                <td> {!! Form::text('row_no_'.$relatedTopic->id,$relatedTopic->row_no, array('class' => 'float-left form-control row_no')) !!}
                                    <small>
                                        {!! $relatedTopic_title !!}
                                    </small>
                                </td>
        ...
        <script type="text/javascript">
            $('#related_section_id').change(function () {
                ...
                $(document).ready(function () {
                    $.ajax({
                        url: '<?php echo url(\Config::get('app.backend_path') . "/relatedLoad"); ?>/' + fid,
                        data: {},
