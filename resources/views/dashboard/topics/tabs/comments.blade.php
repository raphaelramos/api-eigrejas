                ...
                @if (Session::get('commentST') == "create")
                    ...
                    <div>
                        ...
                        <div class="form-group row">
                            <label for="name"
                                   class="col-md-2 form-control-label">{!!  __('backend.topicCommentName') !!}
                            </label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group row">
                            <label for="email"
                                   class="col-md-2 form-control-label">{!!  __('backend.topicCommentEmail') !!}
                            </label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group row">
                            <label for="comment"
                                   class="col-md-2 form-control-label">{!!  __('backend.topicComment') !!}
                            </label>
                            <div class="col-md-10">
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($Topics->comments as $comment)
                            <tr>
                                ...
                                <td>
                                    {!! Form::text('row_no_'.$comment->id,$comment->row_no, array('class' => 'float-left form-control row_no','id'=>'row_no2')) !!}
                                    {{$comment->name}}
                                    <div>
                                        <small>
                                            {{$comment->email}}
