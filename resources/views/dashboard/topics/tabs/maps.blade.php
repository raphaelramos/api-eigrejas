        ...
        <div class="box-body">
            ...
            <div class="row">
                    ...
                    @if (Session::get('mapST') == "edit")
                        <div class="offset-sm-2 col-md-8">
                            ...
                            <div class="form-group row">
                                <label for="longitude"
                                       class="col-md-3 form-control-label">{!!  __('backend.topicMapLocation') !!}
                                </label>
                                <div class="col-md-5">
                            ...
                            @foreach(Helper::languagesList() as $ActiveLanguage)
                                @if($ActiveLanguage->box_status)
                                    <div class="form-group row">
                                        <label
                                            class="col-md-3 form-control-label">{!!  __('backend.topicMapTitle') !!} {!! @Helper::languageName($ActiveLanguage) !!}
                                        </label>
                                        <div class="col-md-9">
                            ...
                            @foreach(Helper::languagesList() as $ActiveLanguage)
                                @if($ActiveLanguage->box_status)
                                    <div class="form-group row">
                                        <label
                                            class="col-md-3 form-control-label">{!!  __('backend.topicMapDetails') !!} {!! @Helper::languageName($ActiveLanguage) !!}
                                        </label>
                                        <div class="col-md-9">
                            ...
                            <div class="form-group row">
                                <label for="link_status"
                                       class="col-md-3 form-control-label">{!!  __('backend.topicMapIcon') !!}</label>
                                <div class="col-md-9">
                                    <div class="radio">
                            ...
                            <div class="form-group row">
                                <label for="link_status"
                                       class="col-md-3 form-control-label">{!!  __('backend.status') !!}</label>
                                <div class="col-md-9">
                                    <div class="radio">
                                        <label class="ui-check ui-check-md">
                ...
                @else
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        @foreach($Topics->maps as $map)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {!! Form::text('row_no_'.$map->id,$map->row_no, array('class' => 'float-left form-control row_no','id'=>'row_no3')) !!}
                                                    <img
                    ...
                    ?>
                    <div id="mapDiv" class="col-md-{{$map_wds}}" {!! $map_dsp !!}>
