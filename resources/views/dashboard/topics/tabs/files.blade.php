        ...
        <div class="box-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <div class="col-md-4 box p-a-xs">
                                    <a target="_blank"
                                       href="{{ global_asset(Session::get('AttachFile')->file) }}"> {!! Helper::GetIcon(global_asset('') ,Session::get('AttachFile')->file) !!} {{ Session::get('AttachFile')->file }} </a>
                                </div>
            ...
            @else
                ...
                @if(count($Topics->attachFiles)>0)
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($Topics->attachFiles as $file)
                            ...
                            <tr>
                                ...
                                <td>
                                    {!! Form::text('row_no_'.$file->id,$file->row_no, array('class' => 'float-left form-control row_no')) !!}
                                    <a href="{{ global_asset($file->file) }}"
                                       target="_blank">
                                        {!! Helper::GetIcon(global_asset('') ,$file->file) !!}
                                        {{$file->file}}</a>
                                </td>
                                <td>
                                    <small>
                    ...
                    <div class="row">
                        <div class="col-md-3 hidden-xsd-none d-sm-block">
                            <!-- .modal -->
