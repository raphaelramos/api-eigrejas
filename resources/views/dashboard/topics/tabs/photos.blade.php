                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="box p-a-xs">
                                <div class="float-right">
                                    {!! Form::text('row_no_'.$photo->id,$photo->row_no, array('class' => 'float-left form-control row_no','style'=>'margin:0;margin-bottom:5px')) !!}
                                </div>
                                ...
                                <img src="{{ global_asset($photo->file) }}"
                                ...
                                <div class="p-a-sm">
                                    <div class="text-ellipsis">
                                        @if(@Auth::user()->permissionsGroup->delete_status)
                                            <button class="btn btn-sm warning float-right"
                                                    data-toggle="modal"
