...
@push("after-styles")
    <link rel="stylesheet" href="{{ global_asset('assets/dashboard/js/datatables/assets/jquery.dataTables.min.css') }}">
@endpush
@section('content')
    <div class="padding">
        <div class="box">
            ...
            <div>
                        ...
                        <div class="filter_div">
                            <div class="row">
                                @if(count($WebmasterSection->customFields->where("in_search",true))==0)
                                    ...
                                    @endif
                                @endif
                                <div class="col-lg-3 col-6 m-b-5p">
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                    ...
                                    @endif
                                @endforeach
                                <div class="col-lg-1 col-6 m-b-5p">
                ...
                <footer class="p-x p-b light dk">
                    <div class="row">
                        <div class="col-md-12 hidden-xsd-none d-sm-block">
                            <!-- .modal -->
...
@push("after-scripts")
    ...
    <script src="{{ global_asset('assets/dashboard/js/datatables/assets/jquery.dataTables.min.js') }}"></script>
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var dataTable = $(table_name).DataTable({
                ...
                "searching": false,
                "responsive": true,
                "pageLength": {{ \Config::get('front.backend_pagination') }},
                "lengthMenu": [[10, 20, 30, 50, 75, 100, 200, -1], [10, 20, 30, 50, 75, 100, 200, "Todos"]],
                "ajax": {
                    "url": "/painel/topics-list",
                    "dataType": "json",
                    "type": "POST",
                    "data": function (data) {
                ...
                "dom": '<"dataTables_wrapper"<"col-md-12 col-lg-9"i><"col-md-12 col-lg-3"l><"col-md-12 col-lg-12"r><"clearfix"s><"col-sm"t><"row b-t p-x p-t light dk"<"col-md-12"p>>>',
        ...
        $("#topic_delete_btn").click(function () {
            $(this).html("<img src=\"{{ global_asset('assets/dashboard/images/loading.gif') }}\" style=\"height: 25px\"/> {!! __('backend.yes') !!}");
