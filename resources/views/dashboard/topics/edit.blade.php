                    ...
                    <div class="box-body">
                        ...
                        @if($WebmasterSection->date_status)
                            <div class="form-group row">
                                <label for="date" class="col-md-2 form-control-label">{!!  __('backend.topicDate') !!}
                                </label>
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <div class="input-group date">
                                            {{ Form::input('dateTime-local', 'date', Helper::formatDateTime($Topics->date), ['id' => 'date', 'class' => 'form-control']) }}
                                        </div>
                                    </div>
                        ...
                        @if($WebmasterSection->expire_date_status)
                            <div class="form-group row">
                                <label for="date"
                                       class="col-md-2 form-control-label">{!!  __('backend.expireDate') !!}
                                </label>
                                <div class="col-md-10">
                                    <div class="form-group">
                        ...
                        @if($WebmasterSection->sections_status!=0)
                            <div class="form-group row">
                                <label for="section_id"
                                       class="col-md-2 form-control-label">{!!  __('backend.hasCategories') !!} </label>
                                <div class="col-md-10">
                        ...
                        @if($WebmasterSection->title_status)
                            @foreach(Helper::languagesList() as $ActiveLanguage)
                                @if($ActiveLanguage->box_status)
                                    <div class="form-group row">
                                        <label
                                            class="col-md-2 form-control-label">{!!  __('backend.topicName') !!} {!! @Helper::languageName($ActiveLanguage) !!}
                                        </label>
                                        <div class="col-md-10">
                            ...
                            <div id="files_div" style="display: {{ ($Topics->video_type ==0) ? "block" : "none" }}">
                                <div class="form-group row">
                                    <label for="video_file"
                                           class="col-md-2 form-control-label">{!!  __('backend.topicVideo') !!}</label>
                                    <div class="col-md-10">
                                        @if($Topics->video_type==0 && $Topics->video_file!="")
                                            <div class="box p-a-xs">

                                                <video width="380" height="230" controls>
                                                    <source src="{{ global_asset($Topics->video_file) }}"
                                                            type="video/mp4">
                                                    Your browser does not support the video tag.
                                                </video>
                                                <br>
                                                <a target="_blank"
                                                   href="{{ global_asset($Topics->video_file) }}">
                                                    {{ $Topics->video_file }} </a>
                                            </div>
                                        @endif
                        ...
                        @if($WebmasterSection->type==3)
                            <div class="form-group row">
                                <label for="audio_file"
                                       class="col-md-2 form-control-label">{!!  __('backend.topicAudio') !!}</label>
                                <div class="col-md-10">
                                    @if($Topics->audio_file!="")
                                        <div class="box p-a-xs">
                                            <audio controls>
                                                <source src="{{ global_asset($Topics->audio_file) }}"
                                                        type="audio/mpeg">
                                                Your browser does not support the audio element.
                                            </audio>
                                            <br>
                                            <a target="_blank"
                                               href="{{ global_asset($Topics->audio_file) }}"> {{ $Topics->audio_file }} </a>
                                        </div>
                                    @endif
                        ...
                        @if($WebmasterSection->type==6)
                            <div class="form-group row">
                                <label for="youtube_channel"
                                    class="col-md-2 form-control-label">{!!  __('backend.topicChannel') !!}</label>
                                <div class="col-md-10">
                                    {!! Form::text('youtube_channel',$Topics->video_file, array('placeholder' => 'https://www.youtube.com/channel/UCm5y5YVK9eJw7Pv6CT1bizQ','class' => 'form-control','id'=>'youtube_channel','required'=>'true','dir'=>'ltr')) !!}
                                </div>
                            </div>
                        @endif
                        ...
                        @if($WebmasterSection->photo_status)
                            <div class="form-group row">
                                <label for="photo_file"
                                       class="col-md-2 form-control-label">{!!  __('backend.topicPhoto') !!}</label>
                                <div class="col-md-10">
                                    @if($Topics->photo_file!="")
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div id="topic_photo" class="col-md-4 box p-a-xs">
                                                    <a target="_blank" href="{{ global_asset($Topics->photo_file) }}">
                                                        <img src="{{ global_asset($Topics->photo_file) }}" class="img-fluid">
                                                    </a>
                                                    <br>
                                                ...
                                                <div id="undo" class="col-md-4 p-a-xs" style="display: none">
                            ...
                            <div class="form-group row m-t-md" style="margin-top: 0 !important;">
                                <div class="offset-sm-2 col-md-10">
                                    <small>
                                        <i class="material-icons">&#xe8fd;</i>
                                        {!!  __('backend.imagesTypes') !!} (600x315px)
                                    </small><br>
                                    <small>
                                        {!!  __('backend.imageCopyright') !!}
                                    </small>
                                </div>
                            </div>
                        @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <div class="input-group">
                                        {!! Form::text('icon',$Topics->icon, array('placeholder' => '','class' => 'form-control','id'=>'icon', 'data-fa-browser')) !!}
                        ...
                        @if($WebmasterSection->attach_file_status)
                            <div class="form-group row">
                                <label for="attach_file"
                                       class="col-md-2 form-control-label">{!!  __('backend.topicAttach') !!}</label>
                                <div class="col-md-10">
                                    @if($Topics->attach_file!="")
                                        <div id="topic_attach" class="col-md-4 box p-a-xs">
                                            <a target="_blank"
                                               href="{{ global_asset($Topics->attach_file) }}"> {{ $Topics->attach_file }} </a>
                                            <br>
                                        ...
                                        <div id="undo2" class="col-md-4 p-a-xs" style="display: none">
                                    ...
                                    @if($customField->type ==12)
                                        ...
                                        <div class="form-group row">
                                            <label for="{{'customField_'.$customField->id}}"
                                                   class="col-md-2 form-control-label">{!!  $cf_title !!}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                @if($cf_saved_val !="")
                                                    ...
                                                    ?>
                                                    <div id="{{$file_name_id}}" class="col-md-4 box p-a-xs">
                                                        <video width="380" height="230" controls>
                                                            <source src="{{ global_asset($cf_saved_val) }}"
                                                                    type="video/mp4">
                                                            Your browser does not support the video tag.
                                                        </video>
                                                        <a target="_blank"
                                                           href="{{ global_asset($cf_saved_val) }}">
                                                            {{ $cf_saved_val }}
                                                        </a>
                                                        <br>
                                                    ...
                                                    <div id="{{$file_undo_id}}" class="col-md-4 p-a-xs"
                                                         style="display: none">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                @if($cf_saved_val !="")
                                                    ...
                                                    <div id="{{$file_name_id}}" class="col-md-4 box p-a-xs">
                                                        <a target="_blank"
                                                           href="{{ global_asset($cf_saved_val) }}"><img
                                                                src="{{ global_asset($cf_saved_val) }}"
                                                                class="img-fluid">
                                                            {{ $cf_saved_val }}
                                                        </a>
                                                        <br>
        ...
        function sendFile(file, editor, welEditable, lang) {
            ...
            $.ajax({
                ...
                success: function (url) {
                    var image = $('<img>').attr('src', '{{ global_asset("") }}/' + url);
                    @foreach(Helper::languagesList() as $ActiveLanguage)
                        @if($ActiveLanguage->box_status)
