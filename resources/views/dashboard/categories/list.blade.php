                        ...
                        @foreach($Sections as $Section)
                            ...
                            <tr>
                                ...
                                <td class="h6">
                                    ...
                                    @endif
                                    {!! Form::text('row_no_'.$Section->id,$Section->row_no, array('class' => 'form-control row_no')) !!}
                                    @if($Section->icon !="")
                                ...
                                <tr>
                                    ...
                                    <td class="h6">
                                        ...
                                        <img
                                            ...
                                            class="submenu_tree">
                                        {!! Form::text('row_no_'.$subSection->id,$subSection->row_no, array('class' => 'form-control row_no')) !!}
                                        @if($subSection->icon !="")
