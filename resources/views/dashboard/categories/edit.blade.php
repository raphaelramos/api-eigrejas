                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                @if($Sections->photo!="")
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div id="section_photo" class="col-md-4 box p-a-xs">
                                                <a target="_blank" href="{{ asset('uploads/sections/'.$Sections->photo) }}">
                                                   <img src="{{ asset('uploads/sections/'.$Sections->photo) }}" class="img-fluid">
                                                </a>
                                                <br>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <div class="input-group">
                                        {!! Form::text('icon',$Sections->icon, array('placeholder' => '','class' => 'form-control','id'=>'icon', 'data-fa-browser')) !!}
