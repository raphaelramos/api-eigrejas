                ...
                <div class="row">
                    <div class="col-md-12 col-lg-5 col-xl-4">
                        ...
                        ?>
                            ...
                            @endforeach
                            <div class="col-12">
                                <div class="box p-a" style="cursor: pointer" onclick="location.href='{{ route('settings') }}'">
                                    <a href="{{ route('settings') }}">
                                        <div class="clear">
                                            <div class="m-a-0 text-md">{{ __('backend.customize') }}</div>
                                        </div>
                                    </a>
                                </div>
                            </div>
...
" style="height:162px">
            ...
            " style="height:200px">
                ...
                <div class="row">
                    ...
                    @if(Helper::GeneralWebmasterSettings("inbox_status"))
                        @if(@Auth::user()->permissionsGroup->inbox_status)
                            <div class="col-lg-12 col-xl-{{$col_width}}">
                                    ...
                                    <div class="box-tool">
                                        <ul class="nav">
                                            <li class="nav-item inline dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-scale float-right">
		                  ...
		                  <i class="material-icons">{!! $unreadIcon !!}</i>
                                        ...
                                        <div class="box-footer">
                                            <a href="{{ route("webmails",["group_id"=>"create"]) }}"
                                               class="btn btn-sm btn-outline b-primary rounded text-u-c float-right">{{ __('backend.compose') }}</a>
