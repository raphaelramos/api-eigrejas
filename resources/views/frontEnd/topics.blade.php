                    ...
                    <ul class="breadcrumb">
                        ...
                        @if($CurrentCategory!="none")
                            @if(!empty($CurrentCategory))
                                ...
                                ?>
                                <li class="active"><i class="icon-angle-right"></i>{{ $CurrentCategory->$category_title_var }}
                                </li>
                            @endif
                        @endif
                    </ul>
