...
@section('content')
    ...
    ?>
    <section itemscope itemtype="https://schema.org/Article" id="inner-headline">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        @if($WebmasterSection->id != 1)
                            ...
                            ?>
                            <li itemprop="name" class="active">{!! $WebmasterSectionTitle !!}</li>
                        @else
                            <li itemprop="name" class="active">{{ $title }}</li>
                        @endif
                        @if(!empty($CurrentCategory))
                            ...
                            ?>
                            <li class="active">
                                <i class="icon-angle-right"></i>{{ $CurrentCategoryTitle }}
                            </li>
                        @endif
                    </ul>
                </div>
                    ...
                    <article itemprop="articleBody">
                                ...
                                <div class="video-container">
                                    ...
                                    @else
                                        <video width="100%" height="450" controls autoplay>
                                            <source src="{{ URL::to($Topic->video_file) }}"
                                                    type="video/mp4">
                        ...
                        @elseif($WebmasterSection->type==3 && $Topic->audio_file!="")
                            ...
                            <div class="post-video">
                                ...
                                @endif
                                @if($Topic->photo_file !="")
                                    <img src="{{ URL::to($Topic->photo_file) }}"
                                         alt="{{ $title }}"/>
                                @endif
                                <div>
                                    <audio controls autoplay>
                                        <source src="{{ URL::to($Topic->audio_file) }}"
                                                type="audio/mpeg">
                                ...
                                <div class="p-slider flexslider">
                                    <ul class="slides">
                                        ...
                                        @foreach($Topic->photos as $photo)
                                            <li>
                                                <img src="{{ URL::to($photo->file) }}" alt="{{ $photo->title  }}"/>
                                            </li>
                                        @endforeach
                        ...
                        @else
                            ...
                            <div class="post-image">
                                ...
                                @if($Topic->photo_file !="")
                                    <img src="{{ URL::to($Topic->photo_file) }}"
                                        class="post-photo" alt="{{ $title }}" title="{{ $title }}"/>
                                    <br>
                                @endif
                            </div>
                        @endif
                                                ...
                                                @if(($cf_saved_val!="" || count($cf_saved_val_array) > 0) && ($customField->lang_code == "all" || $customField->lang_code == @Helper::currentLanguage()->code))
                                                    ...
                                                    @elseif($customField->type ==9)
                                                        ...
                                                        <div class="row field-row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <a href="{{ URL::to($cf_saved_val) }}"
                                                                   target="_blank">
                                                                <span class="badge">
                                                                    {!! Helper::GetIcon(URL::to(),$cf_saved_val) !!}
                                                                    {!! $cf_saved_val !!}</span>
                                                                </a>
                                                            </div>
                                                        </div>
                            ...
                            <div class="bottom-article">
                                @if($file_ext ==".jpg"|| $file_ext ==".jpeg"|| $file_ext ==".png"|| $file_ext ==".gif")
                                    <div class="text-center">
                                        <img src="{{ URL::to($Topic->attach_file) }}"
                                             alt="{{ $title }}"/>
                                    </div>
                                @else
                                    <a href="{{ URL::to($Topic->attach_file) }}">
                                        <strong>
                                            {!! Helper::GetIcon($Topic->attach_file) !!}
                            ...
                            <div style="padding: 10px;border: 1px dashed #ccc;margin-bottom: 10px;">
                                @foreach($Topic->attachFiles as $attachFile)
                                    ...
                                    <div style="margin-bottom: 5px;">
                                        <a href="{{ URL::to($attachFile->file) }}" target="_blank">
                                            <strong>
                                                {!! Helper::GetIcon(URL::to(),$attachFile->file) !!}
                                                &nbsp;{{ $file_title }}</strong>
                                        </a>
                                    </div>
                                @endforeach
                        ...
                        <div class="bottom-article">
                            <ul class="meta-post">
                                @if($WebmasterSection->date_status)
                                    <span itemprop="datePublished" content="{!! $Topic->date  !!}">
                            ...
                            <div class="pull-right">
                                ...
                                <ul class="social-network share">
                                    <li><a href="{{ Helper::SocialShare('facebook', $PageTitle)}}" class="facebook"
                                           data-placement="top"
                                           title="Facebook" target="_blank"><i class="fab fa-facebook"></i></a></li>
