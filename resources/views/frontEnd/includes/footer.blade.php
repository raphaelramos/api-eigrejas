        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="widget contacts">
                        ...
                        @if(Helper::GeneralSiteSettings("contact_t3") !="")
                            <p>
                                ...
                                <a href="tel:{{ Helper::toNumber(Helper::GeneralSiteSettings('contact_t3')) }}">
                ...
                @if(count($LatestNews)>0)
                    ...
                    $footer_title_var2 = "title_" . \Config::get('app.locale');
                    ...
                    <div class="col-lg-{{$bx2w}}">
                        <div class="widget">
                            <h4 class="widgetheading"><i
                                    class="fab fa-rss"></i>&nbsp; {{ __('frontend.latestNews') }}
                            </h4>
                            <ul class="link-list">
                    ...
                    @if(count($FooterMenuLinks)>0)
                        <div class="col-lg-{{$bx3w}}">
                            <div class="widget">
                                ...
                                ?>
                                <h4 class="widgetheading">
                                        <i class="fab fa-bookmark"></i>&nbsp; {{  __('frontend.quickLinks') }}</h4>
                                <ul class="link-list">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="copyright">
                        ...
                        ?>
                        &copy; <?php echo date("Y") ?> {{$WebsiteSettings->$site_title_var}}
                        . <a href="https://eigrejas.com">e-igrejas</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <ul class="social-network">
                        @if($WebsiteSettings->social_link1)
                            <li><a href="{{$WebsiteSettings->social_link1}}" data-placement="top" title="Facebook" target="_blank">
                                    <i class="fab fa-facebook"></i>
                                </a>
                            </li>
                        @endif
                        @if($WebsiteSettings->social_link2)
                            <li><a href="{{$WebsiteSettings->social_link2}}" data-placement="top" title="Twitter" target="_blank">
                                    <i class="fab fa-twitter"></i>
                                </a>
                            </li>
                        @endif
                        @if($WebsiteSettings->social_link4)
                            <li><a href="{{$WebsiteSettings->social_link4}}" data-placement="top" title="linkedin" target="_blank">
                                    <i class="fab fa-linkedin"></i>
                                </a>
                            </li>
                        @endif
                        @if($WebsiteSettings->social_link5)
                            <li><a href="{{$WebsiteSettings->social_link5}}" data-placement="top" title="Youtube" target="_blank">
                                    <i class="fab fa-youtube"></i>
                                </a>
                            </li>
                        @endif
                        @if($WebsiteSettings->social_link6)
                            <li><a href="{{$WebsiteSettings->social_link6}}" data-placement="top" title="Instagram" target="_blank">
                                    <i class="fab fa-instagram"></i>
                                </a>
                            </li>
                        @endif
                        @if($WebsiteSettings->social_link7)
                            <li><a href="{{$WebsiteSettings->social_link7}}" data-placement="top" title="tiktok" target="_blank">
                                    <i class="fab fa-tiktok"></i>
                                </a>
                            </li>
                        @endif
                        @if($WebsiteSettings->social_link8)
                            <li><a href="{{$WebsiteSettings->social_link8}}" data-placement="top" title="Tumblr" target="_blank">
                                    <i class="fab fa-tumblr"></i>
                                </a>
                            </li>
                        @endif
                        @if($WebsiteSettings->social_link9)
                            <li><a href="{{$WebsiteSettings->social_link9}}" data-placement="top" title="Snapchat" target="_blank">
                        ...
                        @endif
                        @if($WebsiteSettings->social_link11)
                            <li><a href="{{$WebsiteSettings->social_link11}}" data-placement="top" title="Snapchat" target="_blank">
                                    <i class="fab fa-telegram"></i>
                                </a>
                            </li>
                        @endif
                        @if($WebsiteSettings->social_link12)
                            <li><a href="{{$WebsiteSettings->social_link12}}" data-placement="top" title="Snapchat" target="_blank">
                                    <i class="fab fa-soundcloud"></i>
                                </a>
                            </li>
                        @endif
                        @if($WebsiteSettings->social_link13)
                            <li><a href="{{$WebsiteSettings->social_link13}}" data-placement="top" title="Snapchat" target="_blank">
